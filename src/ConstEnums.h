...
enum GameMode
{
    ...
    GAMEMODE_SCARY_POTTER_11,
    GAMEMODE_SCARY_POTTER_12, 
    GAMEMODE_SCARY_POTTER_13, 
    GAMEMODE_SCARY_POTTER_14, 
    ...
    GAMEMODE_CHALLENGE_ADV2_2,
    GAMEMODE_CHALLENGE_ADV2_3,
    GAMEMODE_CHALLENGE_ADV2_4,
    GAMEMODE_CHALLENGE_ADV2_5,
    GAMEMODE_CHALLENGE_INFLATION,
    GAMEMODE_CHALLENGE_PROTECT_PLANTS,
    GAMEMODE_CHALLENGE_DYNAMIC_ROOF,
    GAMEMODE_CHALLENGE_INVISIPLANTS,
    GAMEMODE_CHALLENGE_RAINING_SEEDS_2,
    GAMEMODE_CHALLENGE_WE_SMASH,
    GAMEMODE_CHALLENGE_RANDOM_SLOTS,
    NUM_GAME_MODES
};
enum GameObjectType
{
...
enum GridItemType
{
    ...
    GRIDITEM_INFECTION = 13,
    GRIDITEM_SPIKEWEED_BOOST = 14,
    GRIDITEM_SPIKEROCK_BOOST = 15,
    GRIDITEM_PVZ2_GRAVE = 16,
    GRIDITEM_PROTECT_PLANT = 17 
};
enum GridItemState
{
...
enum ProjectileType
{
    ...
    PROJECTILE_CATTAIL_BOOST = 14,
    PROJECTILE_CHERRY = 15,
    PROJECTILE_PLASMABALL = 16,
    PROJECTILE_ICE_CABBAGE = 17,
    PROJECTILE_ACID_LEMON = 18,
    PROJECTILE_SAKURA = 19,
    PROJECTILE_NINJA = 20,
    PROJECTILE_PUFF2 = 21,
    PROJECTILE_MAGNIFYING_GRASS = 22,
    PROJECTILE_PEPPER = 23,
    PROJECTILE_SUN = 24,
    PROJECTILE_GOO = 25,
    PROJECTILE_ROCK = 26,
    PROJECTILE_DROPL = 27,
...
enum SeedType
{
    ...
    ENUM_AUTO_VALUE(SEED_PEPPERPULT)
    ENUM_AUTO_VALUE(SEED_MOONFLOWER)
    ENUM_AUTO_VALUE(SEED_MAGNIFYING_GRASS)
    ENUM_AUTO_VALUE(SEED_TOADSTOOL)
    ENUM_AUTO_VALUE(SEED_CUCKUMBER)
    ENUM_AUTO_VALUE(SEED_GUARDIAN_SHROOM)
    ENUM_AUTO_VALUE(SEED_SAKURA)
    ENUM_AUTO_VALUE(SEED_SPY_PEPPER)
    ...
    ENUM_AUTO_VALUE(SEED_SUNPEA)
    ENUM_AUTO_VALUE(SEED_GOOPEA)
    ENUM_AUTO_VALUE(SEED_ROCKPEA)
    ENUM_AUTO_VALUE(SEED_CPEA)
    ENUM_AUTO_VALUE(SEED_DROPPEA)
    ENUM_AUTO_VALUE(SEED_PRIMALPOTATOMINE)
    ENUM_AUTO_VALUE(SEED_PRIMALSUNFLOWER)
    ...
    ENUM_AUTO_VALUE(SEED_PLASMAWOOD)
    ENUM_AUTO_VALUE(SEED_ACID_LEMON)
    ENUM_AUTO_VALUE(SEED_POISONSHROOM)
    ENUM_AUTO_VALUE(SEED_BEEHIVE)
    ENUM_AUTO_VALUE(SEED_TRAMPALINE)
    ENUM_AUTO_VALUE(SEED_EXPLODE_O_NUT)
    ENUM_AUTO_VALUE(SEED_TIME_APPLE)
    ENUM_AUTO_VALUE(SEED_MINI_GUARDIAN_SHROOM)
    ENUM_AUTO_VALUE(SEED_SUN_BAN)        
    ENUM_AUTO_VALUE(SEED_SPORESHROOM)
    ENUM_AUTO_VALUE(SEED_HAMMER_SHROOM)
    ENUM_AUTO_VALUE(SEED_XSHROOM)
    ENUM_AUTO_VALUE(SEED_SUN_MAGNET)
    ENUM_AUTO_VALUE(SEED_SNAPDRAGON)
...
enum StoreItem
{
    ...
    STORE_ITEM_FIRSTAID,
    STORE_ITEM_PVZ,
    STORE_ITEM_SHOVEL_UPGRADE,
    STORE_ITEM_BOARD_FERTILIZER, 
    STORE_ITEM_BOARD_GLOVE,      
    STORE_ITEM_BOARD_BOOSTER,   
    STORE_ITEM_DIAMOND_SHOVEL,    
    STORE_ITEM_COSMIC_SHOVEL, 
    STORE_ITEM_PLANT_SUNPEA,
    STORE_ITEM_PLANT_GOOPEA,
    STORE_ITEM_PLANT_ROCKPEA,
    STORE_ITEM_PLANT_CPEA,
    STORE_ITEM_PLANT_DROPPEA,
    STORE_ITEM_PLANT_PRIMALPOTATOMINE,
...
enum StorePages
{
    ...
    STORE_PAGE_NEW_UPGRADES = 2,
    STORE_PAGE_ZEN1 = 3,
    STORE_PAGE_ZEN2 = 4,
    STORE_PAGE_NEW_PLANTS = 5,
    NUM_STORE_PAGES = 6       
};
enum TodCurves
{
...
enum TutorialState
{
    ...
    TUTORIAL_GLOVE_INTRO = 31,
    TUTORIAL_GLOVE_PICKUP = 32,
    TUTORIAL_GLOVE_GRAB = 33,
    TUTORIAL_GLOVE_PLANT = 34,
    TUTORIAL_GLOVE_COMPLETED = 35
};
enum UnlockingState
{
    UNLOCK_OFF,
...
enum ZombieType
{
    ...
    ENUM_AUTO_VALUE(ZOMBIE_BRICK)
    ENUM_AUTO_VALUE(ZOMBIE_BUG)
    ENUM_AUTO_VALUE(ZOMBIE_GIGA_FOOTBALL)
    ENUM_AUTO_VALUE(ZOMBIE_BLEUEYE_GARGANTUAR)
    ENUM_AUTO_VALUE(ZOMBIE_BOSS)
    ENUM_AUTO_VALUE(ZOMBIE_REDEYE_GARGANTUAR)
    ENUM_AUTO_VALUE(ZOMBIE_NINJA)
    ENUM_AUTO_VALUE(ZOMBIE_EXA_GARGANTUAR)
    ...
    ENUM_AUTO_VALUE(ZOMBIE_FLY)
    ENUM_AUTO_VALUE(ZOMBIE_COCOON)
    ENUM_AUTO_VALUE(ZOMBIE_SUNDYEDITION)
