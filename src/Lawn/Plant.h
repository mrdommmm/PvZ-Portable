...
public:
    ...
    int                     mTrampalineCharges;
    bool                    mTrampalineHiding;
    bool                    mTrampolineReversed;
    ...
    int                     mTargetX;                       
    int                     mTargetY;                       
    ParticleSystemID        mBoostGlowParticleID; 
    int                     mStartRow;                      
    ...
    bool                    mHighlighted;     
    int                     mBugsEaten;
    bool                    mSunMagnetActive;               
    ParticleSystemID        mSunMagnetAuraID;               
    int                     mTrackedZombieHealth[50];      
    ZombieID                mTrackedZombieID[50];         
    int                     mCoconutClickCount;
    bool                    mIsFlipped;
...
public:
    ...
    void                    RemoveBoost();
    void                    DoSquashDamage();
    Zombie* FindBoostedSquashTarget();
    void                    BurnRow(int theRow);
    GridItem* FindTargetPVZ2Grave(int theRow, PlantWeapon thePlantWeapon = PlantWeapon::WEAPON_PRIMARY);
    void                    IceZombies();
    ...
    void                    UpdateSunMagnet();
    void                    SunMagnetFindTargets();
    bool                    IsASunMagnetAboutToSuck();
    Coin*                   FindSunMagnetTarget();
    void                    UpdateSnapdragon();             
};
