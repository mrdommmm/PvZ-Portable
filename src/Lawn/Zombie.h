...
const Color ZOMBIE_MINDCONTROLLED_COLOR = Color(200, 140, 240, 255);
...
public:
    ...
    float                           mScaleZombie;                               
    float                           mVelZ;                       
    int                             mNinjaTeleportTimer;
    bool                            mNinjaReachedCenter;
    bool                            mNinjaDirectionFlipped;
    bool                            mNinjaIsTeleporting;
    int                             mNinjaTeleportDelayTimer;
    float                           mNinjaTargetX;
    int                             mNinjaTargetRow;
    int                             mNinjaTargetCol;
...
public:
    ...
    void                            ApplyRadioactiveHead(bool theEnableSpecialHead);
