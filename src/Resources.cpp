...
Image* Sexy::IMAGE_ADV2_THUMBNAILS;
...
bool Sexy::ExtractDelayLoad_ChallengeScreenResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_ADV2_THUMBNAILS = aMgr.GetImageThrow("IMAGE_ADV2_THUMBNAILS");
	}
	catch(ResourceManagerException&)
	{
		return false;
...
Image* Sexy::IMAGE_SLOWBUTTON;
Image* Sexy::IMAGE_SLOWBUTTON_HIGHLIGHT;
...
Image* Sexy::IMAGE_PROJECTILECHERRY;
Image* Sexy::IMAGE_ACID;
Image* Sexy::IMAGE_TERA1;
Image* Sexy::IMAGE_TERA2;
Image* Sexy::IMAGE_EXA1;
Image* Sexy::IMAGE_EXA2;
Image* Sexy::IMAGE_PROJECTILECACTUS2;
Image* Sexy::IMAGE_PROJECTILEPEA;
Image* Sexy::IMAGE_PROJECTILEGOO;
Image* Sexy::IMAGE_PROJECTILEROCK;
Image* Sexy::IMAGE_PROJECTILEDROPL;
Image* Sexy::IMAGE_P;
Image* Sexy::IMAGE_BACKGROUND_ECLIPSE;
Image* Sexy::IMAGE_PROJECTILEMAGNIFYING_GRASS;
Image* Sexy::IMAGE_PROJECTILEBEE;
Image* Sexy::IMAGE_PROJECTILESNOWPEA;
Image* Sexy::IMAGE_PROJECTILE_STAR;
Image* Sexy::IMAGE_PUFFSHROOM_PUFF1;
Image* Sexy::IMAGE_PUFFSHROOM_PUFF3;
Image* Sexy::IMAGE_QUICKPLAY_BUTTON;
Image* Sexy::IMAGE_QUICKPLAY_BUTTON_HIGHLIGHT;
Image* Sexy::IMAGE_RAIN;
Image* Sexy::IMAGE_WHITEDOT;
Image* Sexy::IMAGE_RAIN2;
Image* Sexy::IMAGE_PROTECT;
Image* Sexy::IMAGE_BUTTON1;
Image* Sexy::IMAGE_BUTTON2;
Image* Sexy::IMAGE_INFECTION;
Image* Sexy::IMAGE_REANIM_CABBAGEPULT_CABBAGE;
Image* Sexy::IMAGE_REANIM_CABBAGEPULT_CABBAGE2;
...
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_MORE_BUTTON;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_MORE_HIGHLIGHT;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_MOREBACK_BUTTON;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_MOREBACK_HIGHLIGHT;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_EXTRAS_BUTTON;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_EXTRAS_HIGHLIGHT;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_EXTRASBACK_BUTTON;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_EXTRASBACK_HIGHLIGHT;
...
Image* Sexy::IMAGE_NOBLE_PAPER_BODY;
Image* Sexy::IMAGE_NOBLE_PAPER_LEFTARM_LOWER;
Image* Sexy::IMAGE_NOBLE_PAPER_LEFTARM_UPPER;
Image* Sexy::IMAGE_NOBLE_PAPER_LEFTARM_UPPER2;
Image* Sexy::IMAGE_NOBLE_PAPER_RIGHTARM_LOWER;
Image* Sexy::IMAGE_NOBLE_PAPER_RIGHTARM_UPPER;
Image* Sexy::IMAGE_NOBLE_PAPER_PAPER1;
Image* Sexy::IMAGE_NOBLE_PAPER_PAPER2;
Image* Sexy::IMAGE_NOBLE_PAPER_PAPER3;
...
Image* Sexy::IMAGE_SEEDPACKET_GOLDEN;
...
Image* Sexy::IMAGE_SHOVEL_GOLD;
Image* Sexy::IMAGE_SHOVEL_DIAMOND;
Image* Sexy::IMAGE_SHOVEL_COSMIC;
Image* Sexy::IMAGE_SHOVEL;
Image* Sexy::IMAGE_SPIKEROCK;
Image* Sexy::IMAGE_SUN;
Image* Sexy::IMAGE_SPIKWEED;
...
Image* Sexy::IMAGE_REANIM_NINJA_HEAD;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET1;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET3;
Image* Sexy::IMAGE_PROJECTILE_NINJA;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_REANIM_NINJA_HEAD = aMgr.GetImageThrow("IMAGE_REANIM_NINJA_HEAD");
		IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET1 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET1");
		IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET2");
		IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET3 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET3");
		IMAGE_PROJECTILE_NINJA = aMgr.GetImageThrow("IMAGE_PROJECTILE_NINJA");
		...
		IMAGE_SLOWBUTTON = aMgr.GetImageThrow("IMAGE_SLOWBUTTON");
		IMAGE_SLOWBUTTON_HIGHLIGHT = aMgr.GetImageThrow("IMAGE_SLOWBUTTON_HIGHLIGHT");
		...
		IMAGE_PROJECTILECHERRY = aMgr.GetImageThrow("IMAGE_PROJECTILECHERRY");
		IMAGE_ACID = aMgr.GetImageThrow("IMAGE_ACID");
		IMAGE_TERA1 = aMgr.GetImageThrow("IMAGE_TERA1");
		IMAGE_TERA2 = aMgr.GetImageThrow("IMAGE_TERA2");
		IMAGE_EXA1 = aMgr.GetImageThrow("IMAGE_EXA1");
		IMAGE_EXA2 = aMgr.GetImageThrow("IMAGE_EXA2");
		IMAGE_BACKGROUND_ECLIPSE = aMgr.GetImageThrow("IMAGE_BACKGROUND_ECLIPSE");
		IMAGE_PROJECTILECACTUS2 = aMgr.GetImageThrow("IMAGE_PROJECTILECACTUS2");
		IMAGE_PROJECTILEPEA = aMgr.GetImageThrow("IMAGE_PROJECTILEPEA");
		IMAGE_PROJECTILEROCK = aMgr.GetImageThrow("IMAGE_PROJECTILEROCK");
		IMAGE_PROJECTILEGOO = aMgr.GetImageThrow("IMAGE_PROJECTILEGOO");
		IMAGE_PROJECTILEDROPL = aMgr.GetImageThrow("IMAGE_PROJECTILEDROPL");
		IMAGE_P = aMgr.GetImageThrow("IMAGE_P");
		IMAGE_PROJECTILEMAGNIFYING_GRASS = aMgr.GetImageThrow("IMAGE_PROJECTILEMAGNIFYING_GRASS");
		IMAGE_PROJECTILEBEE = aMgr.GetImageThrow("IMAGE_PROJECTILEBEE");
		...
		IMAGE_PUFFSHROOM_PUFF3 = aMgr.GetImageThrow("IMAGE_PUFFSHROOM_PUFF2");
		...
		IMAGE_WHITEDOT = aMgr.GetImageThrow("IMAGE_WHITEDOT");
		IMAGE_RAIN2 = aMgr.GetImageThrow("IMAGE_RAIN2");
		IMAGE_PROTECT = aMgr.GetImageThrow("IMAGE_PROTECT");
		IMAGE_BUTTON1 = aMgr.GetImageThrow("IMAGE_BUTTON1");
		IMAGE_BUTTON2 = aMgr.GetImageThrow("IMAGE_BUTTON2");
		IMAGE_INFECTION = aMgr.GetImageThrow("IMAGE_INFECTION");
		IMAGE_REANIM_CABBAGEPULT_CABBAGE = aMgr.GetImageThrow("IMAGE_REANIM_CABBAGEPULT_CABBAGE");
		IMAGE_REANIM_CABBAGEPULT_CABBAGE2 = aMgr.GetImageThrow("IMAGE_REANIM_CABBAGEPULT_CABBAGE2");
		...
		IMAGE_REANIM_SELECTORSCREEN_MORE_BUTTON = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_MORE_BUTTON");
		IMAGE_REANIM_SELECTORSCREEN_MORE_HIGHLIGHT = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_MORE_HIGHLIGHT");
		IMAGE_REANIM_SELECTORSCREEN_MOREBACK_BUTTON = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_MOREBACK_BUTTON");
		IMAGE_REANIM_SELECTORSCREEN_MOREBACK_HIGHLIGHT = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_MOREBACK_HIGHLIGHT");
		IMAGE_REANIM_SELECTORSCREEN_EXTRAS_BUTTON = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_EXTRAS_BUTTON");
		IMAGE_REANIM_SELECTORSCREEN_EXTRAS_HIGHLIGHT = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_EXTRAS_HIGHLIGHT");
		IMAGE_REANIM_SELECTORSCREEN_EXTRASBACK_BUTTON = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_EXTRASBACK_BUTTON");
		IMAGE_REANIM_SELECTORSCREEN_EXTRASBACK_HIGHLIGHT = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_EXTRASBACK_HIGHLIGHT");
		...
		IMAGE_REANIM_EXPLODE_O_NUT_CRACKED1 = aMgr.GetImageThrow("IMAGE_REANIM_EXPLODE_CRACKED1");
		IMAGE_REANIM_EXPLODE_O_NUT_CRACKED2 = aMgr.GetImageThrow("IMAGE_REANIM_EXPLODE_CRACKED2");
		...
		IMAGE_NOBLE_PAPER_BODY = aMgr.GetImageThrow("IMAGE_NOBLE_PAPER_BODY");
		IMAGE_NOBLE_PAPER_LEFTARM_LOWER = aMgr.GetImageThrow("IMAGE_NOBLE_PAPER_LEFTARM_LOWER");
		IMAGE_NOBLE_PAPER_LEFTARM_UPPER = aMgr.GetImageThrow("IMAGE_NOBLE_PAPER_LEFTARM_UPPER");
		IMAGE_NOBLE_PAPER_LEFTARM_UPPER2 = aMgr.GetImageThrow("IMAGE_NOBLE_PAPER_LEFTARM_UPPER2");
		IMAGE_NOBLE_PAPER_RIGHTARM_LOWER = aMgr.GetImageThrow("IMAGE_NOBLE_PAPER_RIGHTARM_LOWER");
		IMAGE_NOBLE_PAPER_RIGHTARM_UPPER = aMgr.GetImageThrow("IMAGE_NOBLE_PAPER_RIGHTARM_UPPER");
		IMAGE_NOBLE_PAPER_PAPER1 = aMgr.GetImageThrow("IMAGE_NOBLE_PAPER_PAPER1");
		IMAGE_NOBLE_PAPER_PAPER2 = aMgr.GetImageThrow("IMAGE_NOBLE_PAPER_PAPER2");
		IMAGE_NOBLE_PAPER_PAPER3 = aMgr.GetImageThrow("IMAGE_NOBLE_PAPER_PAPER3");
		IMAGE_REANIM_ZOMBIE_BRICK2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_BRICK2");
		...
		IMAGE_SEEDPACKET_GOLDEN = aMgr.GetImageThrow("IMAGE_SEEDPACKET_GOLDEN");
		...
		IMAGE_SHOVEL_GOLD = aMgr.GetImageThrow("IMAGE_SHOVEL_GOLD");
		IMAGE_SHOVEL_DIAMOND = aMgr.GetImageThrow("IMAGE_SHOVEL_DIAMOND");
		IMAGE_SHOVEL_COSMIC = aMgr.GetImageThrow("IMAGE_SHOVEL_COSMIC");
		IMAGE_SPIKEROCK = aMgr.GetImageThrow("IMAGE_SPIKEROCK");
		IMAGE_SUN = aMgr.GetImageThrow("IMAGE_SUN");
		IMAGE_SPIKWEED = aMgr.GetImageThrow("IMAGE_SPIKWEED");
		...
		IMAGE_TOMBSTONES2 = aMgr.GetImageThrow("IMAGE_TOMBSTONES2");
		...
		IMAGE_BOOSTER = aMgr.GetImageThrow("IMAGE_BOOSTER");
...
int Sexy::SOUND_MENU_L;
int Sexy::SOUND_MENU_R;
int Sexy::SOUND_MENU_C;
...
int Sexy::SOUND_PEAGUN;
int Sexy::SOUND_PLANTFOOD;
...
bool Sexy::ExtractLoadingSoundsResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		SOUND_MENU_L = aMgr.GetSoundThrow("SOUND_MENU_L");
		SOUND_MENU_R = aMgr.GetSoundThrow("SOUND_MENU_R");
		SOUND_MENU_C = aMgr.GetSoundThrow("SOUND_MENU_C");
		...
		SOUND_PEAGUN = aMgr.GetSoundThrow("SOUND_PEAGUN");
		SOUND_PLANTFOOD = aMgr.GetSoundThrow("SOUND_PLANTFOOD");
...
static void* gResources[ResourceId::RESOURCE_ID_MAX] =
{
	...
	&IMAGE_BUTTON_MIDDLE,
	&IMAGE_BUTTON_RIGHT,
	& IMAGE_REANIM_NINJA_HEAD,
& IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET1,
& IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET2,
& IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET3,
& IMAGE_PROJECTILE_NINJA,
	&IMAGE_BUTTON_SMALL,
	...
	&IMAGE_PROJECTILEPEA,
	& IMAGE_PROJECTILEGOO,
	& IMAGE_PROJECTILEDROPL,
	& IMAGE_PROJECTILEROCK,
	& IMAGE_P,
	& IMAGE_PROJECTILEMAGNIFYING_GRASS,
	& IMAGE_PROJECTILEBEE,
	&IMAGE_PROJECTILESNOWPEA,
	&IMAGE_PROJECTILECACTUS,
	& IMAGE_PROJECTILECHERRY,
	& IMAGE_ACID,
	& IMAGE_TERA1,
	& IMAGE_TERA2,
	& IMAGE_EXA1,
	& IMAGE_EXA2,
	& IMAGE_BACKGROUND_ECLIPSE,
	& IMAGE_PROJECTILECACTUS2,
	&IMAGE_DIRTSMALL,
	&IMAGE_DIRTBIG,
	&IMAGE_ROCKSMALL,
	&IMAGE_WATERPARTICLE,
	...
	& IMAGE_REANIM_ZOMBIE_BRICK2,
	& IMAGE_REANIM_ZOMBIE_BRICK3,
	& IMAGE_NOBLE_PAPER_BODY,
	& IMAGE_NOBLE_PAPER_LEFTARM_LOWER,
	& IMAGE_NOBLE_PAPER_LEFTARM_UPPER,
	& IMAGE_NOBLE_PAPER_LEFTARM_UPPER2,
	& IMAGE_NOBLE_PAPER_RIGHTARM_LOWER,
	& IMAGE_NOBLE_PAPER_RIGHTARM_UPPER,
	& IMAGE_NOBLE_PAPER_PAPER1,
	& IMAGE_NOBLE_PAPER_PAPER2,
	& IMAGE_NOBLE_PAPER_PAPER3,
	...
	& IMAGE_REANIM_SELECTORSCREEN_MORE_BUTTON,
	& IMAGE_REANIM_SELECTORSCREEN_MORE_HIGHLIGHT,
	& IMAGE_REANIM_SELECTORSCREEN_MOREBACK_BUTTON,
	& IMAGE_REANIM_SELECTORSCREEN_MOREBACK_HIGHLIGHT,
	& IMAGE_REANIM_SELECTORSCREEN_EXTRAS_BUTTON,
	& IMAGE_REANIM_SELECTORSCREEN_EXTRAS_HIGHLIGHT,
	& IMAGE_REANIM_SELECTORSCREEN_EXTRASBACK_BUTTON,
	& IMAGE_REANIM_SELECTORSCREEN_EXTRASBACK_HIGHLIGHT,
	...
	& IMAGE_REANIM_CABBAGEPULT_CABBAGE2,
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_REANIM_NINJA_HEAD_ID: return "IMAGE_REANIM_NINJA_HEAD";
		case IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET1_ID: return "IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET1";
		case IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET2_ID: return "IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET2";
		case IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET3_ID: return "IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET3";
		case IMAGE_PROJECTILE_NINJA_ID: return "IMAGE_PROJECTILE_NINJA";
		...
		case IMAGE_SEEDPACKET_GOLDEN_ID: return "IMAGE_SEEDPACKET_GOLDEN";
		...
		case IMAGE_SHOVEL_GOLD_ID: return "IMAGE_SHOVEL_GOLD";
		case IMAGE_SHOVEL_DIAMOND_ID: return "IMAGE_SHOVEL_DIAMOND";
		case IMAGE_SHOVEL_COSMIC_ID: return "IMAGE_SHOVEL_COSMIC";
		case IMAGE_SPIKEROCK_ID: return "IMAGE_SPIKEROCK";
		case IMAGE_SUN_ID: return "IMAGE_SUN";
		case IMAGE_SPIKWEED_ID: return "IMAGE_SPIKWEED";
		case IMAGE_SHOVEL_HI_RES_ID: return "IMAGE_SHOVEL_HI_RES";
		case IMAGE_TOMBSTONES_ID: return "IMAGE_TOMBSTONES";
		case IMAGE_TOMBSTONES2_ID: return "IMAGE_TOMBSTONES2";
		...
		case IMAGE_BOOSTER_ID: return "IMAGE_BOOSTER";
		...
		case IMAGE_SLOWBUTTON_ID: return "IMAGE_SLOWBUTTON";
		case IMAGE_SLOWBUTTON_HIGHLIGHT_ID: return "IMAGE_SLOWBUTTON_HIGHLIGHT";
		case IMAGE_PRESENT_ID: return "IMAGE_PRESENT";
		case IMAGE_BACKGROUND_ECLIPSE_ID: return "IMAGE_BACKGROUND_ECLIPSE";
		...
		case IMAGE_PROJECTILEROCK_ID: return "IMAGE_PROJECTILEROCK";
		case IMAGE_PROJECTILEGOO_ID: return "IMAGE_PROJECTILEGOO";
		case IMAGE_PROJECTILEDROPL_ID: return "IMAGE_PROJECTILEDROPL";
		case IMAGE_P_ID: return "IMAGE_P";
		case IMAGE_PROJECTILEMAGNIFYING_GRASS_ID: return "IMAGE_PROJECTILEMAGNIFYING_GRASS";
		case IMAGE_PROJECTILEBEE_ID: return "IMAGE_PROJECTILEBEE";
		...
		case IMAGE_PROJECTILECHERRY_ID: return "IMAGE_PROJECTILECHERRY";
		case IMAGE_ACID_ID: return "IMAGE_ACID";
		case IMAGE_TERA1_ID: return "IMAGE_TERA1";
		case IMAGE_TERA2_ID: return "IMAGE_TERA2";
		case IMAGE_EXA1_ID: return "IMAGE_EXA1";
		case IMAGE_EXA2_ID: return "IMAGE_EXA2";
		case IMAGE_PROJECTILECACTUS2_ID: return "IMAGE_PROJECTILECACTUS2";
		...
		case IMAGE_PUFFSHROOM_PUFF3_ID: return "IMAGE_PUFFSHROOM_PUFF2";
		...
		case IMAGE_WHITEDOT_ID: return "IMAGE_WHITEDOT";
		case IMAGE_RAIN2_ID: return "IMAGE_RAIN2";
		case IMAGE_PROTECT_ID: return "IMAGE_PROTECT";
		case IMAGE_BUTTON1_ID: return "IMAGE_BUTTON1";
		case IMAGE_BUTTON2_ID: return "IMAGE_BUTTON2";
		case IMAGE_INFECTION_ID: return "IMAGE_INFECTION";
		...
		case IMAGE_REANIM_EXPLODE_O_NUT_CRACKED1_ID: return "IMAGE_REANIM_EXPLODE_CRACKED1";
		case IMAGE_REANIM_EXPLODE_O_NUT_CRACKED2_ID: return "IMAGE_REANIM_EXPLODE_fCRACKED2";
		...
		case IMAGE_NOBLE_PAPER_BODY_ID: return "IMAGE_NOBLE_PAPER_BODY";
		case IMAGE_NOBLE_PAPER_LEFTARM_LOWER_ID: return "IMAGE_NOBLE_PAPER_LEFTARM_LOWER";
		case IMAGE_NOBLE_PAPER_LEFTARM_UPPER_ID: return "IMAGE_NOBLE_PAPER_LEFTARM_UPPER";
		case IMAGE_NOBLE_PAPER_LEFTARM_UPPER2_ID: return "IMAGE_NOBLE_PAPER_LEFTARM_UPPER2";
		case IMAGE_NOBLE_PAPER_RIGHTARM_LOWER_ID: return "IMAGE_NOBLE_PAPER_RIGHTARM_LOWER";
		case IMAGE_NOBLE_PAPER_RIGHTARM_UPPER_ID: return "IMAGE_NOBLE_PAPER_RIGHTARM_UPPER";
		case IMAGE_NOBLE_PAPER_PAPER1_ID: return "IMAGE_NOBLE_PAPER_PAPER1";
		case IMAGE_NOBLE_PAPER_PAPER2_ID: return "IMAGE_NOBLE_PAPER_PAPER2";
		case IMAGE_NOBLE_PAPER_PAPER3_ID: return "IMAGE_NOBLE_PAPER_PAPER3";
		...
		case IMAGE_REANIM_CABBAGEPULT_CABBAGE2_ID: return "IMAGE_REANIM_CABBAGEPULT_CABBAGE2";
		...
		case SOUND_MENU_L_ID: return "SOUND_MENU_L";
		case SOUND_MENU_R_ID: return "SOUND_MENU_R";
		case SOUND_MENU_C_ID: return "SOUND_MENU_C";
		...
		case SOUND_PEAGUN_ID: return "SOUND_PEAGUN";
		case SOUND_PLANTFOOD_ID: return "SOUND_PLANTFOOD";
		...
		case IMAGE_ADV2_THUMBNAILS_ID: return "IMAGE_ADV2_THUMBNAILS";
